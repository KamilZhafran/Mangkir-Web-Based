    ...
    return (
        <div>
            ...
            <div class="ingredients">
                ...
                <textarea class="form-control" id="ingredientsList" rows="5"></textarea>
            </div>
            <div class="steps">
                <label for="stepsList" class="form-label">Steps</label>
                <textarea class="form-control" id="stepsList" rows="5"></textarea>
            </div>
            <div class="container"> 
                <div class="header"> 
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> 
